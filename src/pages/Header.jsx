    ...
    <Reveal>
      <section className="hero-section">
        <div className="hero-container card">
            ...
            {/* Name */}
            <h2 className="profile-name">Hamza Abdulhakim</h2>

            {/* Title */}
            <h4 className="profile-title">Software Engineering Student</h4>

            {/* Description */}
            <Reveal variant={slideRight}>
              <p className="profile-subtitle">
                Passionate about building modern applications, responsive
                web-tech, solving real-world problems, and continuously growing
                in both technology and Islamic knowledge.
              </p>
            </Reveal>
